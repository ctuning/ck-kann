...
def do(i):
    ...
    ii={'action':'resolve',
        ...
        'out':'con',
        'deps':{'kanndataset':copy.deepcopy(depd)}
    }
    r=ck.access(ii)
    if r['return']>0: return r
    ...
    ii={'action':'resolve',
        ...
        'quiet':'yes', # any model
        'out':'con',
        'deps':{'kannmodel':copy.deepcopy(depm)}
    }
    r=ck.access(ii)
    if r['return']>0: return r
    ...
    for uoad in udepd:
        ...
        for uoam in udepm:
            ...
            ii={'action':'autotune',
                ...
                'tags':[ 'explore-models', framework_tag, platform_tag, version_tag ],
